/******************************************************************
// File: game.cc (part of the namespace main_colin)
//
//  implementation file for game, which is a parent class for
//  derived classes of specific games. Controls turns and also
//  gives outline for programming AI opponent. 
//
